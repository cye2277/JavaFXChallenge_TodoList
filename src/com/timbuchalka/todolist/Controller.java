...
public class Controller {
    ...
    public void showNewItemDialog() {
        ...
        if(result.isPresent() && result.get() == ButtonType.OK) {
            ...
            TodoItem newItem = controller.processResults();//進行儲存資料，並指定新增了為newitem
            todoListView.getItems().setAll(TodoData.getInstance().getTodoItems());  //獲得心得內容重新整理
            todoListView.getSelectionModel().select(newItem);   //選定在新增的
